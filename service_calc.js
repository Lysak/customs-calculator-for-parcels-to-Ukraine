$(function () {
    ...
    var setShipmentCost = function (number ,shippingType) {
        ...
        if(shippingType == 'sea') {var element = seaShipmentCost;}
        if(shippingType == 'shop') {var element = shopShipmentCost;}
        if(shippingType == 'air') {var element = airShipmentCost;}
    ...
    var getWeight = function (shippingType) {
        var weight = 0;
        if(shippingType == 'sea'){weight = seaWeight.val();}
        if(shippingType == 'shop'){weight = shopWeight.val();}
        if(shippingType == 'air'){weight = airParcelWeight.val();}
    ...
    var getDeliveryTypeCost = function (shippingType) {
        ...
        if(shippingType == 'sea'){deliveryTypeCost = seaDeliveryType.val()/100;}
        if(shippingType == 'shop'){deliveryTypeCost = shopDeliveryType.val()/100;}
        if(shippingType == 'air'){deliveryTypeCost = airDeliveryType.val()/100;}
